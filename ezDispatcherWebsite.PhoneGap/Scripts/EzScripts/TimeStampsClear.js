...
function GetClearTimeStamp() {    
    ...
    if (Page == "TimeStampClear") {
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.length > 0) {
                    $.each(result, function (i1, v1) {
                        if (v1.MasterFieldID != "") {
                            DynamicFieldHtml = DynamicFieldHtml + "<div class='ClearDynamicField' MasterFieldId='" + v1.MasterFieldID + "'>"
            ...
            complete: function () {
                $("#ClearDynamicFileds").html(DynamicFieldHtml);                
...
function SaveClearTimeStamps() {
    ...
    jsondata.Obj = [];
    $(".ClearDynamicField").each(function () {
        hasJson = 1;
        var $this = $(this);
        jsondata.Obj.push({
